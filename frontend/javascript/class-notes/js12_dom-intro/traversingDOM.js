...
//? - Yatay yonde (Sibling)
//! anlık yuksek değişimlere ayak uydurmak yani konuma gore hareket yapar.id siz veya id değişimleri çoksa
...
console.log(addItem.parentElement) //? main parentElement ve parentNode aynı şeydir.
console.log(addItem.parentNode.parentNode) //? body

//! closest(): belirtilen elementin parent'larin ilk uygun parent'i secer. zaten kelime anlamıda en yakın demektir.
...
console.log(list.closest("body").querySelector("header h1").innerText) //! body içindeki header içindeki h1 bana getir ve innertext ini oku
